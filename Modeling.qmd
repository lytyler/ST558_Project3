...
*Applying same transformations as in EDA.qmd, except for adding labels*
...
```{r}
#not yet sure best location for storing these
write_csv(m_data, "modelAPI.R/diabetes_modeling_data.csv")
write_csv(m_data, "diabetes_modeling_data.csv")
